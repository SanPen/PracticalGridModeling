...
\begin{marginfigure}
	...
	\caption{Example of cumulative density function of a load.}
	\label{fig:load_CDF}
\end{marginfigure}

\begin{marginfigure}
	\includegraphics[width=\linewidth]{img/Voltage_CDF.eps}
	\caption{Example of cumulative density function of the voltage. This is the Result of a probabilistic power flow.}
...
\marginnote{The derivatives computation using matrix formulation has been introduced in \cite{zimmerman2010ac} which is a very recommendable reading.}
