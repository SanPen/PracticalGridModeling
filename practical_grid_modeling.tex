...
\begin{equation}
{{I}_f = ({C}_f \times {Y}_{bus}) \times {V}}
\end{equation}

\begin{equation}
{{I}_t = ({C}_t \times {Y}_{bus}) \times {V}}
\end{equation}
...
\begin{equation}
{{S}_f = ({C}_f \times {V}) \cdot {I}_f^*}
\end{equation}

\begin{equation}
{{S}_t = ({C}_t \times {V}) \cdot {I}_t^*}
\end{equation}
...
\begin{equation}
{{losses} = |{S}_f - {S}_t| \cdot Sbase}
\end{equation}

And also the branches loading in per unit as:
\begin{equation}
{{loading} = \frac{max(|{S}_f|, |{S}_t|) \cdot Sbase}{ {rate}}}
\end{equation}

Finally we compute the power in all nodes:

\begin{equation}
{S}_{bus} = V \cdot (Y_{bus} \times V - I_{bus})^*
\end{equation}
...
\begin{itemize}
	\item ${Y}_{bus}$: Bus admittance matrix in p.u. See \ref{Y_calculation}.
	\item ${C}_f$: Connectivity matrix of the branches and the \textit{from} buses.
	\item ${C}_t$:Connectivity matrix of the branches and the \textit{to} buses.
	\item ${V}$: Array of bus voltages in p.u.
	\item ${I}_f$: Array of currents at the \textit{from} buses in p.u.
	\item ${I}_t$: Array of currents at the \textit{to} buses in p.u.
	\item ${S}_f$: Array of powers at the \textit{from} buses in p.u.
	\item ${S}_t$: Array of powers at the \textit{to} buses in p.u.	
