...
%			\bottomrule
	...
	\caption{Connectivity matrix of the branch objects with the terminals at the "from" side: $[BR\_T\_from]$}
\end{table}
...
\caption{Connectivity matrix of the branch objects with the terminals at the "to" side: $[BR\_T\_to]$}
\end{table}
...
\marginnote{Here $A$ it is chosen to be a CSC sparse matrix. This is important because the following algorithm uses the CSC sparse structure to find the adjacent elements of a node.}
