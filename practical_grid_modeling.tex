...
\begin{table}[h!]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		\hline
		\rowcolor{maincolor}
		{\color{white}name}  & {\color{white}active} & {\color{white}is\_slack} & {\color{white}Vnom}  & {\color{white}Vmin} & {\color{white}Vmax} \\ \hline
...
\begin{table}[h!]
	...
	\begin{tabular}{|l|l|l|l|l|l|l|l|l|}
		\hline
		\rowcolor{maincolor}
		{\color{white}name}       & {\color{white}bus\_from} & {\color{white}bus\_to} & {\color{white}active}    & {\color{white}rate}  & {\color{white}R}       & {\color{white}X}      & {\color{white}G} & {\color{white}B}       \\ \hline
...
\begin{table}[h!]
	...
	\begin{tabular}{|l|p{3cm}|p{4cm}|}
		\hline 
		\rowcolor{maincolor}
		{\color{white} Parameter} & {\color{white} Description} & {\color{white} Unit} \\ 
		\hline 
...
\begin{table}[h!]
	...
	\begin{tabular}{|l|p{5cm}|p{2cm}|}
		...
		{\color{white} Parameter} & {\color{white} Description} & {\color{white} Unit} \\ 
		\hline 
		Q & Reactive Power rated at the bus nominal voltage (complex number) & MVAr \\ 
		\hline
	\end{tabular} 
\end{table}
